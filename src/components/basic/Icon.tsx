...
const inlineIconPaths: Record<string, string> = {
...
export const Icon: React.FC<IconProps> = ({
  ...
  if (inlineIconPaths[iconName] && !spin && !pulse && !size && !color) {
    const svgProps = props as unknown as React.SVGProps<SVGSVGElement>;
    ...
    return (
      ...
      >
        <path d={inlineIconPaths[iconName]} />
      </svg>
    );
  }
