...
const logger = ((window as any).G7Core?.createLogger?.('Template:glitter-gallery_bz')) ?? {
    log: (...args: unknown[]) => console.log('[Template:glitter-gallery_bz]', ...args),
    warn: (...args: unknown[]) => console.warn('[Template:glitter-gallery_bz]', ...args),
    error: (...args: unknown[]) => console.error('[Template:glitter-gallery_bz]', ...args),
};
